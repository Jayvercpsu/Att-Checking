    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Instructor</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-file-o"></i><a href="add-teacher.php">Add Instructor</a></li>
                        <li><i class="menu-icon fa fa-file-o"></i><a href="manage-teacher.php">Manage Instructor</a></li>
                    </ul>
                </li>
